...
package ESP32_C6_SVD.PCNT is
   ...
   subtype U_CONF_FILTER_THRES_Field is HAL.UInt10;
   subtype U_CONF_CH0_NEG_MODE_Field is HAL.UInt2;
   subtype U_CONF_CH0_POS_MODE_Field is HAL.UInt2;
   subtype U_CONF_CH0_HCTRL_MODE_Field is HAL.UInt2;
   subtype U_CONF_CH0_LCTRL_MODE_Field is HAL.UInt2;
   subtype U_CONF_CH1_NEG_MODE_Field is HAL.UInt2;
   subtype U_CONF_CH1_POS_MODE_Field is HAL.UInt2;
   subtype U_CONF_CH1_HCTRL_MODE_Field is HAL.UInt2;
   subtype U_CONF_CH1_LCTRL_MODE_Field is HAL.UInt2;
   ...
   subtype U_CONF_CNT_THRES_Element is HAL.UInt16;
   ...
   subtype U_CONF_CNT_H_LIM_Field is HAL.UInt16;
   subtype U_CONF_CNT_L_LIM_Field is HAL.UInt16;
   ...
   subtype U_CNT_CNT_Field is HAL.UInt16;
   ...
   subtype U_STATUS_ZERO_MODE_Field is HAL.UInt2;
