...
package ESP32_C6_SVD.RSA is
   ...
   --  The memory that stores M
   type M_MEM_Registers is array (0 .. 383) of HAL.UInt8;

   --  The memory that stores Z

   --  The memory that stores Z
   type Z_MEM_Registers is array (0 .. 383) of HAL.UInt8;

   --  The memory that stores Y

   --  The memory that stores Y
   type Y_MEM_Registers is array (0 .. 383) of HAL.UInt8;

   --  The memory that stores X

   --  The memory that stores X
   type X_MEM_Registers is array (0 .. 383) of HAL.UInt8;
