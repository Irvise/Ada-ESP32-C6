...
package ESP32_C6_SVD.SHA is
   ...
   type DATE_Register is record
      ...
      DATE           : DATE_DATE_Field := 16#20201229#;
      --  unspecified
   ...
   --  Sha H memory which contains intermediate hash or finial hash.
   type H_MEM_Registers is array (0 .. 63) of HAL.UInt8;

   --  Sha M memory which contains message.

   --  Sha M memory which contains message.
   type M_MEM_Registers is array (0 .. 63) of HAL.UInt8;
