...
package ESP32_C6_SVD.AES is
   ...
   --  The memory that stores GCM hash subkey
   type H_MEM_Registers is array (0 .. 15) of HAL.UInt8;

   --  The memory that stores J0

   --  The memory that stores J0
   type J0_MEM_Registers is array (0 .. 15) of HAL.UInt8;

   --  The memory that stores T0

   --  The memory that stores T0
   type T0_MEM_Registers is array (0 .. 15) of HAL.UInt8;
