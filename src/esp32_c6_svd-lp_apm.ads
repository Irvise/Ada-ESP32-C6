...
package ESP32_C6_SVD.LP_APM is
   pragma Preelaborate;
   ...
   subtype M1_EXCEPTION_INFO0_M1_EXCEPTION_REGION_Field is HAL.UInt4;
   ...
   for M1_EXCEPTION_INFO0_Register use record
      M1_EXCEPTION_REGION at 0 range 0 .. 3;
      Reserved_4_15       at 0 range 4 .. 15;
   ...
   type LP_APM_Peripheral is record
      --  Region filter enable register
   ...
   for LP_APM_Peripheral use record
      ...
      INT_EN             at 16#E8# range 0 .. 31;
      CLOCK_GATE         at 16#EC# range 0 .. 31;
      DATE               at 16#FC# range 0 .. 31;
   end record;

   --  Low-power Access Permission Management Controller
   LP_APM_Periph : aliased LP_APM_Peripheral
     with Import, Address => LP_APM_Base;

end ESP32_C6_SVD.LP_APM;
