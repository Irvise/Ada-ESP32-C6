...
package ESP32_C6_SVD.I2C is
   ...
   subtype FIFO_ST_SLAVE_RW_POINT_Field is HAL.UInt8;
   ...
   subtype DATA_FIFO_RDATA_Field is HAL.UInt8;
   ...
   type INT_RAW_Register is record
      ...
      --  Read-only. The raw interrupt bit for I2C_SLAVE_ADDR_UNMATCH_INT_RAW
      --  interrupt.
      SLAVE_ADDR_UNMATCH_INT_RAW : Boolean;
      --  unspecified
   ...
   for INT_RAW_Register use record
      ...
      SLAVE_ADDR_UNMATCH_INT_RAW at 0 range 18 .. 18;
   ...
   type INT_CLR_Register is record
      ...
      --  Write-only. Set this bit to clear I2C_GENARAL_CALL_INT interrupt.
      GENERAL_CALL_INT_CLR       : Boolean := False;
      --  Write-only. Set this bit to clear I2C_SLAVE_ADDR_UNMATCH_INT_RAW
      --  interrupt.
      SLAVE_ADDR_UNMATCH_INT_CLR : Boolean := False;
      --  unspecified
   ...
   for INT_CLR_Register use record
      ...
      SLAVE_ADDR_UNMATCH_INT_CLR at 0 range 18 .. 18;
      Reserved_19_31             at 0 range 19 .. 31;
   end record;
   ...
   type INT_ENA_Register is record
      ...
      SLAVE_ADDR_UNMATCH_INT_ENA : Boolean := False;
      --  unspecified
      Reserved_19_31             : HAL.UInt13 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for INT_ENA_Register use record
      ...
      SLAVE_ADDR_UNMATCH_INT_ENA at 0 range 18 .. 18;
      Reserved_19_31             at 0 range 19 .. 31;
   end record;
   ...
   type INT_STATUS_Register is record
      ...
      --  I2C_SLAVE_ADDR_UNMATCH_INT interrupt.
      SLAVE_ADDR_UNMATCH_INT_ST : Boolean;
      --  unspecified
      Reserved_19_31            : HAL.UInt13;
   end record
     with Volatile_Full_Access, Object_Size => 32,
   ...
   for INT_STATUS_Register use record
      ...
      SLAVE_ADDR_UNMATCH_INT_ST at 0 range 18 .. 18;
      Reserved_19_31            at 0 range 19 .. 31;
   end record;
