...
package ESP32_C6_SVD.SYSTIMER is
   pragma Preelaborate;
   ...
   subtype REAL_TARGET0_HI_TARGET0_HI_RO_Field is HAL.UInt20;
   ...
   subtype REAL_TARGET1_HI_TARGET1_HI_RO_Field is HAL.UInt20;
   ...
   subtype REAL_TARGET2_HI_TARGET2_HI_RO_Field is HAL.UInt20;
