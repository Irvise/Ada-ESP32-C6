...
package ESP32_C6_SVD.SPI2 is
   ...
   subtype CTRL_RD_BIT_ORDER_Field is HAL.UInt2;
   subtype CTRL_WR_BIT_ORDER_Field is HAL.UInt2;
   ...
   type CTRL_Register is record
      ...
      --  Read-only. Apply 8 signals during addr phase 1:enable 0: disable. Can
      ...
      --  Read-only. In the read operations read-data phase apply 8 signals. 1:
   ...
   type USER_Register is record
      ...
      --  Read-only. Just for master mode. 1: spi controller is in OPI mode
      --  (all in 8-b-m). 0: others. Can be configured in CONF state.
      ...
      --  Read-only. In the write operations read-data phase apply 8 signals.
      --  Can be configured in CONF state.
   ...
   subtype USER1_USR_DUMMY_CYCLELEN_Field is HAL.UInt8;
   ...
   type MISC_Register is record
      ...
      --  Read-only. 1: SPI master DTR mode is applied to SPI clk, data and
      --  spi_dqs. 0: SPI master DTR mode is only applied to spi_dqs. This bit
      --  should be used with bit 17/18/19.
      CLK_DATA_DTR_EN   : Boolean := False;
      --  Read-only. 1: SPI clk and data of SPI_DOUT and SPI_DIN state are in
      --  DTR mode, including master 1/2/4/8-bm. 0: SPI clk and data of
      --  SPI_DOUT and SPI_DIN state are in STR mode. Can be configured in CONF
      --  state.
      DATA_DTR_EN       : Boolean := False;
      --  Read-only. 1: SPI clk and data of SPI_SEND_ADDR state are in DTR
      --  mode, including master 1/2/4/8-bm. 0: SPI clk and data of
      --  SPI_SEND_ADDR state are in STR mode. Can be configured in CONF state.
      ADDR_DTR_EN       : Boolean := False;
      --  Read-only. 1: SPI clk and data of SPI_SEND_CMD state are in DTR mode,
      --  including master 1/2/4/8-bm. 0: SPI clk and data of SPI_SEND_CMD
      ...
      --  Read-only. The default value of spi_dqs. Can be configured in CONF
      --  state.
   ...
   subtype DIN_MODE_DIN4_MODE_Field is HAL.UInt2;
   subtype DIN_MODE_DIN5_MODE_Field is HAL.UInt2;
   subtype DIN_MODE_DIN6_MODE_Field is HAL.UInt2;
   subtype DIN_MODE_DIN7_MODE_Field is HAL.UInt2;
   ...
   type DIN_MODE_Register is record
      ...
      --  Read-only. the input signals are delayed by SPI module clock cycles,
      --  0: input without delayed, 1: input with the posedge of clk_apb,2
      --  input with the negedge of clk_apb, 3: input with the spi_clk. Can be
      --  configured in CONF state.
   ...
   subtype DIN_NUM_DIN4_NUM_Field is HAL.UInt2;
   subtype DIN_NUM_DIN5_NUM_Field is HAL.UInt2;
   subtype DIN_NUM_DIN6_NUM_Field is HAL.UInt2;
   subtype DIN_NUM_DIN7_NUM_Field is HAL.UInt2;
   ...
   type DIN_NUM_Register is record
      ...
      --  Read-only. the input signals are delayed by SPI module clock cycles,
      --  0: delayed by 1 cycle, 1: delayed by 2 cycles,... Can be configured
      --  in CONF state.
   ...
   type DOUT_MODE_Register is record
      ...
      --  Read-only. The output signal 4 is delayed by the SPI module clock, 0:
      ...
      --  Read-only. The output signal 5 is delayed by the SPI module clock, 0:
      --  output without delayed, 1: output delay for a SPI module clock cycle
      --  at its negative edge. Can be configured in CONF state.
      DOUT5_MODE    : Boolean := False;
      --  Read-only. The output signal 6 is delayed by the SPI module clock, 0:
      --  output without delayed, 1: output delay for a SPI module clock cycle
      --  at its negative edge. Can be configured in CONF state.
      DOUT6_MODE    : Boolean := False;
      --  Read-only. The output signal 7 is delayed by the SPI module clock, 0:
      --  output without delayed, 1: output delay for a SPI module clock cycle
      --  at its negative edge. Can be configured in CONF state.
      DOUT7_MODE    : Boolean := False;
      --  Read-only. The output signal SPI_DQS is delayed by the SPI module
      --  clock, 0: output without delayed, 1: output delay for a SPI module
      --  clock cycle at its negative edge. Can be configured in CONF state.
   ...
   type SLAVE_Register is record
      ...
      --  In master full-duplex mode, 1: GP-SPI will wait DMA TX data is ready
      --  before starting SPI transfer. 0: GP-SPI does not wait DMA TX data
      --  before starting SPI transfer.
      MST_FD_WAIT_DMA_TX_DATA : Boolean := False;
      --  unspecified
   ...
   for SLAVE_Register use record
      ...
      MST_FD_WAIT_DMA_TX_DATA at 0 range 29 .. 29;
      Reserved_30_31          at 0 range 30 .. 31;
   end record;

   subtype SLAVE1_SLV_DATA_BITLEN_Field is HAL.UInt18;
   subtype SLAVE1_SLV_LAST_COMMAND_Field is HAL.UInt8;
   ...
   type DATE_Register is record
      ...
      DATE           : DATE_DATE_Field := 16#2201300#;
      --  unspecified
