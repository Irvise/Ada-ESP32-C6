...
package ESP32_C6_SVD.HMAC is
   ...
   --  Message block memory.
   type WR_MESSAGE_MEM_Registers is array (0 .. 63) of HAL.UInt8;

   --  Result from upstream.

   --  Result from upstream.
   type RD_RESULT_MEM_Registers is array (0 .. 31) of HAL.UInt8;
