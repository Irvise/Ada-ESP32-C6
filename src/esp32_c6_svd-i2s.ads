...
package ESP32_C6_SVD.I2S is
   ...
   subtype RX_CLKM_CONF_RX_CLKM_DIV_NUM_Field is HAL.UInt8;
   ...
   subtype TX_CLKM_CONF_TX_CLKM_DIV_NUM_Field is HAL.UInt8;
   ...
   subtype TX_PCM2PDM_CONF_TX_PDM_PRESCALE_Field is HAL.UInt8;
   ...
   subtype LC_HUNG_CONF_LC_FIFO_TIMEOUT_Field is HAL.UInt8;
   ...
   subtype ETM_CONF_ETM_TX_SEND_WORD_NUM_Field is HAL.UInt10;
   subtype ETM_CONF_ETM_RX_RECEIVE_WORD_NUM_Field is HAL.UInt10;
   ...
   type ETM_CONF_Register is record
      ...
      ETM_TX_SEND_WORD_NUM    : ETM_CONF_ETM_TX_SEND_WORD_NUM_Field := 16#40#;
      --  I2S ETM receive x words event. When receiving word number of
      --  reg_etm_rx_receive_word_num[9:0], i2s will trigger an etm event.
      ETM_RX_RECEIVE_WORD_NUM : ETM_CONF_ETM_RX_RECEIVE_WORD_NUM_Field :=
                                 16#40#;
      --  unspecified
      Reserved_20_31          : HAL.UInt12 := 16#0#;
   end record
   ...
   for ETM_CONF_Register use record
      ETM_TX_SEND_WORD_NUM    at 0 range 0 .. 9;
      ETM_RX_RECEIVE_WORD_NUM at 0 range 10 .. 19;
      Reserved_20_31          at 0 range 20 .. 31;
   end record;
   ...
   type DATE_Register is record
      ...
      DATE           : DATE_DATE_Field := 16#2201070#;
      --  unspecified
      Reserved_28_31 : HAL.UInt4 := 16#0#;
   end record
     with Volatile_Full_Access, Object_Size => 32,
