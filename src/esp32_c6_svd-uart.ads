...
package ESP32_C6_SVD.UART is
   ...
   subtype STATUS_RXFIFO_CNT_Field is HAL.UInt8;
   subtype STATUS_TXFIFO_CNT_Field is HAL.UInt8;
   ...
   for CONF0_Register use record
      ...
      IRDA_DPLX      at 0 range 7 .. 7;
      IRDA_TX_EN     at 0 range 8 .. 8;
      IRDA_WCTL      at 0 range 9 .. 9;
      IRDA_TX_INV    at 0 range 10 .. 10;
      IRDA_RX_INV    at 0 range 11 .. 11;
      LOOPBACK       at 0 range 12 .. 12;
      TX_FLOW_EN     at 0 range 13 .. 13;
      IRDA_EN        at 0 range 14 .. 14;
      RXD_INV        at 0 range 15 .. 15;
      TXD_INV        at 0 range 16 .. 16;
      DIS_RX_DAT_OVF at 0 range 17 .. 17;
      ERR_WR_MASK    at 0 range 18 .. 18;
      AUTOBAUD_EN    at 0 range 19 .. 19;
   ...
   subtype CONF1_RXFIFO_FULL_THRHD_Field is HAL.UInt8;
   subtype CONF1_TXFIFO_EMPTY_THRHD_Field is HAL.UInt8;
   ...
   for CONF1_Register use record
      RXFIFO_FULL_THRHD  at 0 range 0 .. 7;
      TXFIFO_EMPTY_THRHD at 0 range 8 .. 15;
   ...
   subtype HWFC_CONF_RX_FLOW_THRHD_Field is HAL.UInt8;
   ...
   subtype SLEEP_CONF2_RX_WAKE_UP_THRHD_Field is HAL.UInt8;
   ...
   for SLEEP_CONF2_Register use record
      ...
      RX_WAKE_UP_THRHD at 0 range 10 .. 17;
   ...
   subtype SWFC_CONF1_XON_THRESHOLD_Field is HAL.UInt8;
   subtype SWFC_CONF1_XOFF_THRESHOLD_Field is HAL.UInt8;
   ...
   type SWFC_CONF1_Register is record
      ...
      XOFF_THRESHOLD : SWFC_CONF1_XOFF_THRESHOLD_Field := 16#E0#;
      --  unspecified
   ...
   for SWFC_CONF1_Register use record
      XON_THRESHOLD  at 0 range 0 .. 7;
      XOFF_THRESHOLD at 0 range 8 .. 15;
   ...
   subtype MEM_TX_STATUS_TX_SRAM_WADDR_Field is HAL.UInt8;
   subtype MEM_TX_STATUS_TX_SRAM_RADDR_Field is HAL.UInt8;
   ...
   for MEM_TX_STATUS_Register use record
      TX_SRAM_WADDR  at 0 range 0 .. 7;
      Reserved_8_8   at 0 range 8 .. 8;
      TX_SRAM_RADDR  at 0 range 9 .. 16;
      Reserved_17_31 at 0 range 17 .. 31;
   end record;

   subtype MEM_RX_STATUS_RX_SRAM_RADDR_Field is HAL.UInt8;
   subtype MEM_RX_STATUS_RX_SRAM_WADDR_Field is HAL.UInt8;
   ...
   for MEM_RX_STATUS_Register use record
      RX_SRAM_RADDR  at 0 range 0 .. 7;
      Reserved_8_8   at 0 range 8 .. 8;
      RX_SRAM_WADDR  at 0 range 9 .. 16;
      Reserved_17_31 at 0 range 17 .. 31;
   end record;
   ...
   for UART_Peripheral use record
      ...
      POSPULSE       at 16#74# range 0 .. 31;
      NEGPULSE       at 16#78# range 0 .. 31;
      LOWPULSE       at 16#7C# range 0 .. 31;
      HIGHPULSE      at 16#80# range 0 .. 31;
      RXD_CNT        at 16#84# range 0 .. 31;
